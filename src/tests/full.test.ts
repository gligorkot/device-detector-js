...
const tests: any = [
  ...
  ...require("../fixtures/Tests/fixtures/desktop-1.json"),
  ...
  ...require("../fixtures/Tests/fixtures/peripheral.json"),
  ...require("../fixtures/Tests/fixtures/phablet.json"),
  ...require("../fixtures/Tests/fixtures/phablet-1.json"),
  ...require("../fixtures/Tests/fixtures/podcasting.json"),
  ...
  ...require("../fixtures/Tests/fixtures/smartphone-26.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-27.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-28.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-29.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-30.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-31.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-32.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-33.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-34.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-35.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-36.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-37.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-38.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-39.json"),
  ...require("../fixtures/Tests/fixtures/smartphone-40.json"),
  ...
  ...require("../fixtures/Tests/fixtures/tablet-6.json"),
  ...require("../fixtures/Tests/fixtures/tablet-7.json"),
  ...require("../fixtures/Tests/fixtures/tablet-8.json"),
  ...require("../fixtures/Tests/fixtures/tablet-9.json"),
  ...require("../fixtures/Tests/fixtures/tablet-10.json"),
  ...require("../fixtures/Tests/fixtures/tablet-11.json"),
  ...require("../fixtures/Tests/fixtures/tv.json"),
  ...require("../fixtures/Tests/fixtures/tv-1.json"),
  ...require("../fixtures/Tests/fixtures/tv-2.json"),
  ...require("../fixtures/Tests/fixtures/tv-3.json"),
  ...require("../fixtures/Tests/fixtures/tv-4.json"),
