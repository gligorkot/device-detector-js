...
#### This is a javascript port of [Matomo device-detector](https://github.com/matomo-org/device-detector) (5.0.5).
...
aiohttp, Akka HTTP, AnyEvent HTTP, Apache HTTP Client, Aria2, C++ REST SDK, curl, Embarcadero URI Client, Faraday, Go-http-client, Google HTTP Java Client, GRequests, Guzzle (PHP HTTP Client), gvfs, HTTPie, HTTP_Request2, Jakarta Commons HttpClient, Java, Java HTTP Client, jsdom, libdnf, LUA OpenResty NGINX, Mechanize, Mikrotik Fetch, Node Fetch, OkHttp, Perl, Perl REST::Client, Postman Desktop, Python Requests, Python urllib, ReactorNetty, REST Client for Ruby, RestSharp, ScalaJ HTTP, SlimerJS, uclient-fetch, Unirest for Java, urlgrabber (yum), uTorrent, Wget, Windows HTTP, WinHttp WinHttpRequest, WWW-Mechanize
...
- **Ayan Dey** - _Contributor_ - [linkedin.com/in/dey-ayan](https://www.linkedin.com/in/iayandey)
- **Julien Maitrehenry** - _Contributor_ - [linkedin.com/in/jmaitrehenry](https://www.linkedin.com/in/jmaitrehenry)
- **Gligor Kotushevski** - _Contributor_ - [linkedin.com/in/gligorkotushevski](https://www.linkedin.com/in/gligorkotushevski/)
